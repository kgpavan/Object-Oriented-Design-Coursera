...
public class EditContactActivity extends AppCompatActivity implements Observer {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        contact = userListController.getUser(pos);
    ...
    public void saveContact(View view) {
        ...
        boolean success = userListController.editUser(contact, updated_contact, context);
        if (!success){
            return;
        }
    ...
    public void deleteContact(View view) {
        ...
        ContactListController userListController = new ContactListController(contact_list);
        boolean success = userListController.deleteUser(contact, context);
